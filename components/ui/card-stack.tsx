            ...
            {items.map((it, idx) => (
              <button
                ...
                className={cn(
                  ...
                  idx === active ? "bg-gray-900" : "bg-gray-300 hover:bg-gray-500",
                )}
  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-5">
        ...
        {item.tag ? (
          <span className="mt-2 inline-block w-fit rounded-full bg-white/20 backdrop-blur-sm px-3 py-0.5 text-xs font-medium text-white">
            {item.tag}
          </span>
        ) : null}
      </div>
